...
namespace Hazel {
	...
	static void CopyComponent(entt::registry& dst, entt::registry& src, const std::unordered_map<UUID, entt::entity> enttMap)
	{
		...
		for (auto e : view)
		{
			...
			auto& componenet = src.get<Component>(e);
			dst.emplace_or_replace<Component>(dstEnttID, componenet);
		}
	}
	...
	void Scene::OnUpdateEditor(Timestep ts, EditorCamera& camera)
	{
		...
		// Renderer2D::DrawRect(glm::vec3(0.0f), glm::vec3(1.0f), glm::vec4(0, 1, 1, 1));
