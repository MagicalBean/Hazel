...
namespace Hazel {
	...
	void SceneHeirarchyPanel::DrawEntityNode(Entity entity)
	{
		...
		//flags |= ImGuiTreeNodeFlags_SpanAvailWidth; // TODO: figure out why ImGui doesn't have this
	...
	//template <typename T, typename name, typename entity, typename lambda>
	//void DrawComponent(name, entity, lambda) {
	//	if (entity.HasComponent<T>())
	//		HZ_INFO("Has Component");
	//
	//}
