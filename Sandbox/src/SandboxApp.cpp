...
public:
		...
		: Layer("Example"), m_CameraController(1280.0f / 720.0f)
	{
		...
		Hazel::Ref<Hazel::VertexBuffer> vertexBuffer = Hazel::VertexBuffer::Create(verticies, sizeof(verticies));
		...
		Hazel::Ref<Hazel::VertexBuffer> squareVB  = Hazel::VertexBuffer::Create(squareVerticies, sizeof(squareVerticies));
		squareVB->SetLayout({
			{ Hazel::ShaderDataType::Float3, "a_Position" },
